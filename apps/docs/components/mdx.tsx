...
export function Mdx({ children }: { children: React.ReactNode }) {
  return (
    <div
      ...
      prose-code:rounded-b prose-h1:first-of-type:mt-0 prose-headings:mt-6 prose-h2:text-2xl flex flex-col gap-4 prose-ul:list-disc prose-ul:list-inside prose-ul:space-y-2 prose-h3:text-xl grow`}
    >
      {children}
    </div>
  );
