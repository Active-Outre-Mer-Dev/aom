...
items-center ring-offset-neutral-50 dark:ring-offset-neutral-900`,
  {
    variants: {
      color: {
        ...
        ring-primary-200/60 dark:ring-primary-600/60`,
        ...
        ring-secondary-200/60 dark:ring-secondary-600/60`,
        ...
        ring-error-200/60 dark:ring-error-600/60`
      },
      variant: {
        light: ``,
        subtle: ``
