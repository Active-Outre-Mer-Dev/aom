...
const styles = cva(
  `ui-rounded-full ui-px-2 ui-text-sm ui-inline-flex ui-justify-center ui-items-center ui-py-1`,
  {
    variants: {
      color: {
      ...
      size: {
        ...
        md: "ui-text-sm ui-px-2 ui-py-1",
        lg: "ui-text-base ui-px-2 ui-py-1"
      }
    },
    defaultVariants: {
      color: "primary",
