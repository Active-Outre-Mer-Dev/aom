...
export const Slider = forwardRef<HTMLInputElement, PropTypes>((props, ref) => (
  <>
    ...
    >
      ...
      >
        <RadixSlider.Range
          className={`ui-absolute ui-bg-primary-600 dark:ui-bg-primary-200 ui-rounded-full 
        ui-h-full`}
        />
      </RadixSlider.Track>
      <RadixSlider.Thumb
        className={`ui-block ui-w-5 ui-h-5 ui-bg-primary-600 dark:ui-bg-primary-200 ui-outline-none 
